---
标题: "实战工具|目标检测评价map精细化系列工具"
公众号名称: "张大刀修炼手册"
作者: "张大刀修炼手册"
发布时间: "2022-04-27 23:34:34"
原文链接: "https://mp.weixin.qq.com/s/-5XmukT12TTD5JBG4tOOQQ"
文章详情_分享类型: "0"
文章ID: "2247494457"
是否已删除: "False"
版权状态: "11"
...
文章详情_投票ID: "[]"
文章详情_超级投票ID: "[]"
文章详情_封面图片: "https://mmbiz.qlogo.cn/mmbiz_jpg/xH40kQxnnibFqQZotialAHhWLzrqxEH1gPBSAJFec6yvnafsoGyLpRPjIFl1WgYWPRqCNbabgqJ9hJyA7VIObeww/0?wx_fmt=jpeg"
文章详情_智能产品信息: "0"
文章详情_修改状态: "1"
文章详情_互动类型: "2"
文章详情_可删除状态: "0"
...
文章详情_是否开启粉丝留言: "0"
文章详情_是否处于冷却状态: "0"
文章详情_2.35比1封面地址: "https://mmbiz.qlogo.cn/mmbiz_jpg/xH40kQxnnibFqQZotialAHhWLzrqxEH1gPibN8mEhSKhhQsWBlulStVxia9J6ICUZric26w0wr2tSfgRhQOmTK832tw/0?wx_fmt=jpeg"
文章详情_16比9封面地址: "https://mmbiz.qlogo.cn/mmbiz_jpg/xH40kQxnnibFqQZotialAHhWLzrqxEH1gPibN8mEhSKhhQsWBlulStVxia9J6ICUZric26w0wr2tSfgRhQOmTK832tw/0?wx_fmt=jpeg"
文章详情_是否禁止推荐: "0"
文章详情_发布线路信息: "{\"use_line\": 1, \"line_count\": 1, \"send_time\": 1651073674, \"is_appmsg_flag\": 1, \"is_use_flag\": 0}"
文章详情_来源声明类型: "0"
分享量: "5"
文章详情_是否辟谣文章: "0"
文章详情_是否多图封面: "0"
...
发布消息ID: "1000000041"
发布类型: "101"
发送状态: "{\"total\": 1161, \"succ\": 1161, \"fail\": 0, \"progress\": 100, \"userprotect\": 0}"
发布结果: "{\"msg_status\": 2, \"refuse_reason\": \"\", \"reject_index_list\": [], \"update_time\": 1752674451}"
是否新发布: "0"
文章详情_发布复制类型: "77"
文章详情_发布复制文章ID: "100010808"
...
大家好，我是张大刀，前两天写完目标检测的评价标准map后，有人在后台私信我如果map只能对目标检测大概评价，那具体到具体项目，真的要每次自己去将检测结果过一遍，人为去发现漏检和误检的数据特征吗？额，作为人工智能当然不允许这样的事情发生。想起来之前在公众号中写到的**TIDE**模块，开始以为是某one的实用模块，后来才发现原来大佬是发了ECCV2020，孤陋寡闻了。。立马拜读下。这一拜读后，竟然发现很多惊喜。

![]()

对于目标检测，常见使用map做为评价指标，详情可以看[《【小白入坑篇】目标检测的评价指标map》](http://mp.weixin.qq.com/s?__biz=MzU3ODk2Njc5Mg==&mid=2247494316&idx=1&sn=8f367d235bf5e5a757f05fc2ecede0fc&chksm=fd6feecbca1867dd6677ef5df97c03ed90d0cfdcefc46f3618140a88874ca9f03804ef0514d4&scene=21#wechat_redirect)，map能大概评估目标检测模型的性能，在实际的检测过程中，还要对map庖丁解牛。然后在读TIDE模块时，意外发现几个其他几个优秀的工具，对于白嫖党的我，只想说：
...
[4]https://arxiv.org/abs/1911.12451<Empirical Upper Bound in Object Detection and More>

[5]https://github.com/aliborji/DetectionUpperbound

[6] https://arxiv.org/pdf/2008.08115.pdf<TIDE: A General Toolbox for Identifying Object
Detection Errors>
